...
const REQUIRED = {
  tables: ['users', 'rooms', 'guests', 'collections', 'purchases', 'guest_rent_history', 'guest_room_history', 'deposit_refunds',
    ...
    'checklist_items', 'checklist_log', 'complaints', 'ai_reads', 'reminder_log', 'owner_reports', 'ai_proposals', 'ai_actions', 'request_comments', 'request_photos', 'day_closings', 'collection_variances', 'meal_ratings', 'visitors', 'announcement_reads', 'satisfaction_responses', 'notifications', 'outbox', 'resident_documents', 'maintenance_schedule'],
